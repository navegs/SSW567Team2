...
public class BuggyTriangleTest {
	...
	public void isoscelesTest() {
		...
		assertEquals("failure - should be Isoceles", "Isosceles", tester.classifyTriangle(3, 3, 5));
		assertEquals("failure - should be Isoceles", "Isosceles", tester.classifyTriangle(3, 5, 3));
		assertEquals("failure - should be Isoceles", "Isosceles", tester.classifyTriangle(5, 3, 3));
	...
	public void scaleneTest() {
		...
		assertEquals("failure - should be Isoceles", "Scalene", tester.classifyTriangle(2, 3, 4));
		assertEquals("failure - should be Isoceles", "Scalene", tester.classifyTriangle(3, 4, 2));
		assertEquals("failure - should be Isoceles", "Scalene", tester.classifyTriangle(4, 2, 3));
	...
	public void invalidTriangleTest() {
		...
		// Negative Numbers for each parameter
		assertEquals("failure - should be Not a", "InvalidInput", tester.classifyTriangle(-1, 4, 8));
		assertEquals("failure - should be Not a", "InvalidInput", tester.classifyTriangle(4, -1, 8));
		assertEquals("failure - should be Not a", "InvalidInput", tester.classifyTriangle(4, 8, -1));
		
		// Zeros for each parameter
		assertEquals("failure - should be Not a", "InvalidInput", tester.classifyTriangle(0, 4, 8));
		assertEquals("failure - should be Not a", "InvalidInput", tester.classifyTriangle(4, 0, 8));
		assertEquals("failure - should be Not a", "InvalidInput", tester.classifyTriangle(4, 8, 0));

		// values greater than 200
		assertEquals("failure - should be Not a", "InvalidInput", tester.classifyTriangle(201, 204, 8));
		assertEquals("failure - should be Not a", "InvalidInput", tester.classifyTriangle(204, 201, 8));
		assertEquals("failure - should be Not a", "InvalidInput", tester.classifyTriangle(204, 8, 201));
	...
	// 	If the sum of the square of any two sides equals the square of the third side, then return 'Right' 
	@Test
	public void trueRightAngleTest() {
		
		assertEquals("failure - should be true", "Right Scalene", tester.classifyTriangle(3, 4, 5)); 
		assertEquals("failure - should be true", "Right Scalene", tester.classifyTriangle(4, 5, 3)); 
		assertEquals("failure - should be true", "Right Scalene", tester.classifyTriangle(5, 3, 4));
